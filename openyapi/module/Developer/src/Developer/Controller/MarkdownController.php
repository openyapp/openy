...
class MarkdownController extends AbstractActionController
{
    public function indexAction()
    {
        ...
        $data = $this->params()->fromRoute('namespace', 0);
    	$path = $this->params()->fromRoute('filename', 0);
    	...
    	if($data)
    	{
    	    ...
    	    if(file_exists(APPLICATION_PATH."/docs/developer/".$path."/".$filename.".md"))
    	    {
    	        $data = file_get_contents(APPLICATION_PATH."/docs/developer/".$path."/".$filename.".md");
